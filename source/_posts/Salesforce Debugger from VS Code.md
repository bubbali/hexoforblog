...
Assumed that you have a project in your local machine. if don't have. This [article]([https://www.jianshu.com/p/74aacac5ea5f](https://www.jianshu.com/p/74aacac5ea5f)
) may help you. Because the log had generated by Salesforce server. And you can get logs not only by download from Salesforce. But also you get the remote log from vs code by Salesforce extension. Open the vs code command palette. Type the **SFDX:Get Apex Debug Logs**. It may need to spend some time. The response will display many logs. you can pick the log by username and create time. Finally. The log your selected will download in your local automatically. 
